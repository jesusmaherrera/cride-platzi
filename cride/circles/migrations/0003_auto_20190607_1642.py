# Generated by Django 2.2.1 on 2019-06-07 16:42
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('users', '0001_initial'),
        ('circles', '0002_auto_20190522_1614'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_admin', models.BooleanField(default=False, help_text="Circle admisn can update the cirlce's data and manage its members.", verbose_name='circle admin')),
                ...
                ('is_active', models.BooleanField(default=True, help_text='Only active users are allowed to interact in the cirlce.', verbose_name='active status')),
